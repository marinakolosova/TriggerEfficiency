...
def main(args):
    ...
    fdir = f.GetDirectory("pfhtTrigAnalyzerNanoAOD")
    statOption = ROOT.TEfficiency.kFCP

    variables  = ["pfht", "pv"]
    triggers   = ["passedL1", "passedHLT"]
    ...
    for var in variables:
        ...
        for j, trg in enumerate(triggers):
            ...
            if j == 0:
                ...
                effs[trg].Draw("same")
            leg.AddEntry(effs[trg], trg.replace("passed", ""), "ep")
        ...
        for fs in args.formats:
            savename = f'plots/TrgEffs_PFHT_{var}{fs}'
            c.SaveAs(savename)
...
if __name__ == "__main__":
    ...
    VERBOSE       = True
    YEAR          = "2023"
    TRGROOTFILE   = "histos_PFHTTrigNanoAOD.root"
    FORMATS       = ['.png', '.pdf']
